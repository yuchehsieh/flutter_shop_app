...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(
    ...
    try {
      ...
      // if have Map to store json.encode({''})
      // encoded to json(json is always a string!)
    } catch (e) {
      throw e;
    }
  }
  ...
  void logout() async {
    ...
    notifyListeners();
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.remove('userData'); // remove single item
    // prefs.clear(); // clear all data stored in SharedPreference
  }
